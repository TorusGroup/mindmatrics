...
import { Award, Users, Target, Brain, Activity, MessageCircle, Compass, ArrowRight } from 'lucide-react';
        ...
        <section className="p-12 md:p-24 bg-gradient-to-b from-[#080808] to-black">
          <div className="max-w-4xl mx-auto">
             <div className="flex items-center gap-6 mb-16">
               <div className="w-16 h-16 bg-sage/10 text-sage rounded-2xl flex items-center justify-center border border-sage/20">
                 <MessageCircle size={32} />
               </div>
               <div>
                  <h2 className="font-serif text-5xl text-white">{t('reports.common.deepInsights')}</h2>
                  <p className="text-gray-500 uppercase tracking-widest text-[10px] font-black">AI-Powered Psychological Mapping</p>
               </div>
             </div>
